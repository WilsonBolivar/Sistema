...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2017 a las 08:53:33
...
INSERT INTO `direcbecado` (`id`, `Estado`, `Municipio`, `Parroquia`, `Ciudad`, `Direccion`) VALUES
(1, 'Aragua', 'Sucre', 'sucre', 'cagua', 'calle comercio sector centro 3 casa nº 40'),
(2, 'Aragua', 'Sucre', 'Sucre', 'cagua', 'calle Comercio sector centro 3 casa 40');
...
INSERT INTO `direcrepre` (`id`, `Id_repre`, `Estado`, `Municipio`, `Parroquia`, `Ciudad`, `Direccion`) VALUES
(1, 1, 'Aragua', 'Santiago Mariño', 'Santigo Mariño', 'Turmero', 'Calle Camili Torres conunto Residencias turmero Conjunto 2 edificio 2 piso 2 apartamento 10');
...
INSERT INTO `repre` (`id`, `Cedula`, `Identificacion`, `PriNombre`, `SegNombre`, `PriApellido`, `SegApellido`, `Sexo`, `FechaNaci`, `Nacionalidad`) VALUES
(1, 25527330, 1, 'wilson', 'alexander', 'bolivar', 'requena', 'M', '1994-08-02', 'Venezolano'),
(2, 255273311, 2, 'jose', 'mod', 'awd', 'fwefwef', 'M', '2010-03-01', 'venezolano');
...
(1, 'admin', '*4ACFE3202A5FF5CF467898FC58AAB1D615029441', 'Administrador'),
(2, 'privi', '*77F792430A3FB81E6466934A0A016111D0258288', 'Privilejiado'),
(3, 'comun', '*28749237E2009D60A9E9BE8475B6DA1C075598FF', 'Comun');
